...
import 'package:prefs_client/prefs_client.dart' as _i11;
...
class _FakePackageInfo_26 extends _i1.SmartFake implements _i7.PackageInfo {
  _FakePackageInfo_26(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeFile_27 extends _i1.SmartFake implements _i8.File {
  _FakeFile_27(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeSendPort_28 extends _i1.SmartFake implements _i9.SendPort {
  _FakeSendPort_28(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeNavigatorObserver_29 extends _i1.SmartFake
    implements _i10.NavigatorObserver {
...
class MockPrefsClient extends _i1.Mock implements _i11.PrefsClient {
  MockPrefsClient() {
    _i1.throwOnMissingStub(this);
  }

  @override
  bool get textInputHapticEnabled => (super.noSuchMethod(
    Invocation.getter(#textInputHapticEnabled),
    returnValue: false,
  ) as bool);

  @override
  bool get otherHapticEnabled => (super.noSuchMethod(
    Invocation.getter(#otherHapticEnabled),
    returnValue: false,
  ) as bool);

  @override
  List<Map<String, dynamic>> get notificationSettings => (super.noSuchMethod(
    Invocation.getter(#notificationSettings),
    returnValue: <Map<String, dynamic>>[],
  ) as List<Map<String, dynamic>>);

  @override
  bool get hasDeclinedInAppReview => (super.noSuchMethod(
    Invocation.getter(#hasDeclinedInAppReview),
    returnValue: false,
  ) as bool);

  @override
  bool get hasShownDiaryImageNotice => (super.noSuchMethod(
    Invocation.getter(#hasShownDiaryImageNotice),
    returnValue: false,
  ) as bool);

  @override
  _i6.Future<bool> setTextInputHapticEnabled({required bool? enabled}) =>
      (super.noSuchMethod(
        Invocation.method(#setTextInputHapticEnabled, [], {#enabled: enabled}),
        returnValue: _i6.Future<bool>.value(false),
      ) as _i6.Future<bool>);

  @override
  _i6.Future<bool> setOtherHapticEnabled({required bool? enabled}) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<bool> setNotificationSettings(
  ...
  @override
  _i6.Future<bool> setHasDeclinedInAppReview({required bool? value}) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<bool> setLastInAppReviewShownAt({required int? timestamp}) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<bool> setHasShownDiaryImageNotice({required bool? shown}) =>
      (super.noSuchMethod(
        Invocation.method(#setHasShownDiaryImageNotice, [], {#shown: shown}),
        returnValue: _i6.Future<bool>.value(false),
      ) as _i6.Future<bool>);
}
...
class MockDbClient extends _i1.Mock implements _i3.DbClient {
  ...
  @override
  _i3.$DbClientManager get managers => (super.noSuchMethod(
    Invocation.getter(#managers),
    returnValue: _Fake$DbClientManager_1(this, Invocation.getter(#managers)),
  ) as _i3.$DbClientManager);

  @override
  _i3.$DiariesTable get diaries => (super.noSuchMethod(
    Invocation.getter(#diaries),
    returnValue: _Fake$DiariesTable_2(this, Invocation.getter(#diaries)),
  ) as _i3.$DiariesTable);

  @override
  _i3.$DiaryImagesTable get diaryImages => (super.noSuchMethod(
  ...
  @override
  _i2.Index get idxDiariesDate => (super.noSuchMethod(
    Invocation.getter(#idxDiariesDate),
    returnValue: _FakeIndex_4(this, Invocation.getter(#idxDiariesDate)),
  ) as _i2.Index);

  @override
  _i2.Index get idxDiaryImagesDiaryId => (super.noSuchMethod(
    Invocation.getter(#idxDiaryImagesDiaryId),
    returnValue: _FakeIndex_4(this, Invocation.getter(#idxDiaryImagesDiaryId)),
  ) as _i2.Index);
  ...
  _i2.DriftDatabaseOptions get options => (super.noSuchMethod(
    ...
    returnValue: _FakeDriftDatabaseOptions_7(this, Invocation.getter(#options)),
  ...
  _i4.QueryExecutor get executor => (super.noSuchMethod(
    ...
    returnValue: _FakeQueryExecutor_9(this, Invocation.getter(#executor)),
  ...
  @override
  _i6.Future<void> writeBackupToFile({required String? filePath}) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<_i3.DiaryEntry> insertDiary({
    required String? content,
    required DateTime? date,
  }) => (super.noSuchMethod(
    Invocation.method(#insertDiary, [], {#content: content, #date: date}),
    returnValue: _i6.Future<_i3.DiaryEntry>.value(
      _FakeDiaryEntry_12(
        this,
        Invocation.method(#insertDiary, [], {#content: content, #date: date}),
      ),
    ),
  ) as _i6.Future<_i3.DiaryEntry>);

  @override
  _i6.Future<List<_i3.Diary>> getDiaries({
    required DateTime? from,
    required DateTime? to,
  }) => (super.noSuchMethod(
    Invocation.method(#getDiaries, [], {#from: from, #to: to}),
    returnValue: _i6.Future<List<_i3.Diary>>.value(<_i3.Diary>[]),
  ) as _i6.Future<List<_i3.Diary>>);

  @override
  _i6.Future<int> updateDiary({required int? id, required String? content}) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<List<_i3.DiaryEntry>> searchDiaries({
    ...
    returnValue: _i6.Future<List<_i3.DiaryEntry>>.value(<_i3.DiaryEntry>[]),
  ) as _i6.Future<List<_i3.DiaryEntry>>);

  @override
  _i6.Future<int> countUniqueDaysWithContentInRange({
    required DateTime? from,
    required DateTime? to,
  }) => (super.noSuchMethod(
  ...
  @override
  _i6.Future<_i3.DiaryImage> insertDiaryImage({
    ...
    returnValue: _i6.Future<_i3.DiaryImage>.value(
      _FakeDiaryImage_13(
        this,
        Invocation.method(#insertDiaryImage, [], {
          #diaryId: diaryId,
  ...
  ) as _i6.Future<_i3.DiaryImage>);

  @override
  _i6.Future<int> deleteDiaryImage({required int? id}) => (super.noSuchMethod(
    Invocation.method(#deleteDiaryImage, [], {#id: id}),
    returnValue: _i6.Future<int>.value(0),
  ) as _i6.Future<int>);

  @override
  _i6.Stream<int> watchDiaryImageCount() => (super.noSuchMethod(
  ...
  _i2.Migrator createMigrator() => (super.noSuchMethod(
    ...
    returnValue: _FakeMigrator_14(this, Invocation.method(#createMigrator, [])),
  ) as _i2.Migrator);
  ...
  _i6.Future<T> exclusively<T>(_i6.Future<T> Function()? action) =>
      (super.noSuchMethod(
        ...
        returnValue:
            ...
            _FakeFuture_15<T>(this, Invocation.method(#exclusively, [action])),
      ) as _i6.Future<T>);
...
class MockBackupController extends _i1.Mock implements _i13.BackupController {
  ...
  @override
  _i3.DbClient get dbClient => (super.noSuchMethod(
    Invocation.getter(#dbClient),
    returnValue: _FakeDbClient_24(this, Invocation.getter(#dbClient)),
  ) as _i3.DbClient);

  @override
  _i3.DbConnection get dbConnection => (super.noSuchMethod(
    Invocation.getter(#dbConnection),
    returnValue: _FakeDbConnection_25(this, Invocation.getter(#dbConnection)),
  ) as _i3.DbConnection);

  @override
  _i7.PackageInfo get packageInfo => (super.noSuchMethod(
    Invocation.getter(#packageInfo),
    returnValue: _FakePackageInfo_26(this, Invocation.getter(#packageInfo)),
  ) as _i7.PackageInfo);

  @override
  String get appName => (super.noSuchMethod(
    Invocation.getter(#appName),
    returnValue: _i12.dummyValue<String>(this, Invocation.getter(#appName)),
  ) as String);

  @override
  String get version => (super.noSuchMethod(
    Invocation.getter(#version),
    returnValue: _i12.dummyValue<String>(this, Invocation.getter(#version)),
  ) as String);

  @override
  _i6.Future<void> createBackupFile() => (super.noSuchMethod(
  ...
  @override
  _i6.Future<String?> restoreBackupFile() => (super.noSuchMethod(
...
class MockPdfExporter extends _i1.Mock implements _i14.PdfExporter {
  ...
  @override
  _i6.Future<_i8.File> export({required List<_i15.ExportDiary>? entries}) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<_i8.File> exportMonth({
  ...
  @override
  _i6.Future<_i8.File> exportDateRange({
    required List<_i15.ExportDiary>? entries,
...
class MockInAppReviewer extends _i1.Mock implements _i19.InAppReviewer {
  ...
  @override
  _i6.Future<bool> shouldShowReviewPrompt() => (super.noSuchMethod(
    Invocation.method(#shouldShowReviewPrompt, []),
    returnValue: _i6.Future<bool>.value(false),
  ) as _i6.Future<bool>);

  @override
  _i6.Future<void> requestReview() => (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> openStoreListing() => (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> checkAndShowReviewIfEligible() => (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> markAsDeclined() => (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> recordReviewShown() => (super.noSuchMethod(
...
class MockTracker extends _i1.Mock implements _i20.Tracker {
  ...
  @override
  _i6.Future<void> onFlutterError(
    _i21.FlutterErrorDetails? flutterErrorDetails, {
    bool? fatal = false,
  }) => (super.noSuchMethod(
    Invocation.method(#onFlutterError, [flutterErrorDetails], {#fatal: fatal}),
    returnValue: _i6.Future<void>.value(),
    returnValueForMissingStub: _i6.Future<void>.value(),
  ) as _i6.Future<void>);

  @override
  bool onPlatformError(Object? error, StackTrace? stack) => (super.noSuchMethod(
    Invocation.method(#onPlatformError, [error, stack]),
    returnValue: false,
  ) as bool);

  @override
  _i9.SendPort isolateErrorListener() => (super.noSuchMethod(
  ...
  _i6.Future<void> recordError(
    ...
    Invocation.method(#recordError, [exception, stack], {#fatal: fatal}),
    returnValue: _i6.Future<void>.value(),
    returnValueForMissingStub: _i6.Future<void>.value(),
  ) as _i6.Future<void>);
  ...
  @override
  _i6.Future<void> clearUserId() => (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> setUserProperties(Map<String, String?>? properties) =>
      (super.noSuchMethod(
  ...
  @override
  _i10.NavigatorObserver navigatorObserver({
    String? Function(_i10.RouteSettings)? nameExtractor =
        _i22.defaultNameExtractor,
    bool Function(_i10.Route<dynamic>?)? routeFilter = _i22.defaultRouteFilter,
  }) => (super.noSuchMethod(
  ...
  ) as _i10.NavigatorObserver);

  @override
  List<_i10.NavigatorObserver> navigatorObservers({
    String? Function(_i10.RouteSettings)? nameExtractor =
        _i22.defaultNameExtractor,
    bool Function(_i10.Route<dynamic>?)? routeFilter = _i22.defaultRouteFilter,
  }) => (super.noSuchMethod(
    ...
    returnValue: <_i10.NavigatorObserver>[],
  ) as List<_i10.NavigatorObserver>);

  @override
  _i6.Future<void> trackScreenView(String? screenName) => (super.noSuchMethod(
  ...
  _i6.Future<void> logEvent(
    ...
    Invocation.method(#logEvent, [eventName], {#parameters: parameters}),
    returnValue: _i6.Future<void>.value(),
    returnValueForMissingStub: _i6.Future<void>.value(),
  ) as _i6.Future<void>);
}
...
class MockNotificationClient extends _i1.Mock
  ...
  @override
  _i6.Future<void> scheduleNotifications(
