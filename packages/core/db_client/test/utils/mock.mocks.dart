...
import 'package:sqlite3/src/functions.dart' as _i9;
import 'package:sqlite3/src/result_set.dart' as _i10;
...
class _FakePreparedStatement_1 extends _i1.SmartFake
  ...
  _FakePreparedStatement_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockSqlite3 extends _i1.Mock implements _i2.Sqlite3 {
  @override
  Iterable<String> get compileOptions => (super.noSuchMethod(
  ...
  _i3.Version get version => (super.noSuchMethod(
    ...
    returnValue: _i4.dummyValue<_i3.Version>(this, Invocation.getter(#version)),
  ...
  _i2.Database open(
    ...
    Invocation.method(
      #open,
      [filename],
      {#vfs: vfs, #mode: mode, #uri: uri, #mutex: mutex},
    ),
  ...
  _i2.Database openInMemory({String? vfs}) => (super.noSuchMethod(
    Invocation.method(#openInMemory, [], {#vfs: vfs}),
    returnValue: _FakeDatabase_0(
      this,
      Invocation.method(#openInMemory, [], {#vfs: vfs}),
    ),
  ...
  _i2.Database copyIntoMemory(_i2.Database? restoreFrom) => (super.noSuchMethod(
    Invocation.method(#copyIntoMemory, [restoreFrom]),
    returnValue: _FakeDatabase_0(
      this,
      Invocation.method(#copyIntoMemory, [restoreFrom]),
    ),
  ...
  @override
  bool usedCompileOption(String? name) => (super.noSuchMethod(
  ...
  void unregisterVirtualFileSystem(_i6.VirtualFileSystem? vfs) =>
      super.noSuchMethod(
        Invocation.method(#unregisterVirtualFileSystem, [vfs]),
        returnValueForMissingStub: null,
      );
}
...
class MockDatabase extends _i1.Mock implements _i2.Database {
  ...
  @override
  _i8.Stream<_i7.SqliteUpdate> get updatesSync => (super.noSuchMethod(
  ...
  @override
  _i8.Stream<void> get commits => (super.noSuchMethod(
  ...
  @override
  _i8.Stream<void> get rollbacks => (super.noSuchMethod(
    Invocation.getter(#rollbacks),
    returnValue: _i8.Stream<void>.empty(),
    returnValueForMissingStub: _i8.Stream<void>.empty(),
  ) as _i8.Stream<void>);
  ...
  @override
  set commitFilter(_i9.VoidPredicate? commitFilter) => super.noSuchMethod(
    Invocation.setter(#commitFilter, commitFilter),
    returnValueForMissingStub: null,
  );
  ...
  @override
  _i5.Pointer<void> leak() => (super.noSuchMethod(
  ...
  List<_i2.PreparedStatement> prepareMultiple(
    ...
    Invocation.method(
      #prepareMultiple,
      [sql],
      {#persistent: persistent, #vtab: vtab},
    ),
  ...
  _i8.Stream<double> backup(_i2.Database? toDatabase, {int? nPage = 5}) =>
      (super.noSuchMethod(
        Invocation.method(#backup, [toDatabase], {#nPage: nPage}),
  ...
  int getUpdatedRows() => (super.noSuchMethod(
    Invocation.method(#getUpdatedRows, []),
    returnValue: 0,
    returnValueForMissingStub: 0,
  ) as int);
  ...
  @override
  _i10.ResultSet select(String? sql, [List<Object?>? parameters = const []]) =>
      (super.noSuchMethod(
        Invocation.method(#select, [sql, parameters]),
        returnValue: _i4.dummyValue<_i10.ResultSet>(
          this,
          Invocation.method(#select, [sql, parameters]),
        ),
        returnValueForMissingStub: _i4.dummyValue<_i10.ResultSet>(
          this,
          Invocation.method(#select, [sql, parameters]),
        ),
      ) as _i10.ResultSet);
  ...
  void createCollation({
    ...
    required _i9.CollatingFunction? function,
  }) => super.noSuchMethod(
    Invocation.method(#createCollation, [], {#name: name, #function: function}),
    returnValueForMissingStub: null,
  );
  ...
  void createFunction({
    ...
    required _i9.ScalarFunction? function,
    _i9.AllowedArgumentCount? argumentCount =
  ...
  void createAggregateFunction<V>({
    required String? functionName,
    required _i9.AggregateFunction<V>? function,
    _i9.AllowedArgumentCount? argumentCount =
        const _i9.AllowedArgumentCount.any(),
    bool? deterministic = false,
    bool? directOnly = true,
