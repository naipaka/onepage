...
// in tracker/test/utils/mock.dart.
...
import 'package:tracker/src/trackable.dart' as _i8;
...
/// A class which mocks [Trackable].
///
/// See the documentation for Mockito's code generation for more information.
class MockTrackable extends _i1.Mock implements _i8.Trackable {
  @override
  _i4.Future<void> trackError(
    ...
    Invocation.method(#trackError, [error, stackTrace], {#fatal: fatal}),
    returnValue: _i4.Future<void>.value(),
    returnValueForMissingStub: _i4.Future<void>.value(),
  ) as _i4.Future<void>);

  @override
  _i4.Future<void> trackScreenView(String? screenName) => (super.noSuchMethod(
  ...
  _i4.Future<void> trackEvent(
    ...
    Invocation.method(#trackEvent, [name], {#parameters: parameters}),
    returnValue: _i4.Future<void>.value(),
    returnValueForMissingStub: _i4.Future<void>.value(),
  ) as _i4.Future<void>);
